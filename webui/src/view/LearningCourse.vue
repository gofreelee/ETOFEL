        ...
        <el-form ref="search_form" :inline="true" :model="searchCondition" class="demo-form-inline">
            ...
            <el-form-item label="讲师">
                <el-select v-model="selectedTeacher" placeholder="讲师">
                    <el-option v-for="(item, index) in searchCondition.teacher_list" :key="index + '_teacher'"
                               :label="item" :value="item"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="课程类别">
                <el-select v-model="selectedCourseType" placeholder="课程类别">
                    <el-option v-for="(item, index) in searchCondition.course_type_list" :key="index + '_type'"
                               :label="item" :value="item"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item>
