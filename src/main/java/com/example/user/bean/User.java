...
public class User {
    ...
    public User(String usr_username, String usr_password, String usr_nickname,
                String usr_gender, String usr_email, String usr_phone,
                Date usr_birthday, String usr_sign, String usr_portrait) {
        this.usr_username = usr_username;
        this.usr_password = usr_password;
        this.usr_nickname = usr_nickname;
        this.usr_gender = usr_gender;
